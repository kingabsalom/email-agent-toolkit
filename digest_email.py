...
def format_digest(rows: list, suggested_subjects: list = None) -> str:
    """
...
def send_digest(rows: list, suggested_subjects: list = None) -> str:
    """
    ...
    body = format_digest(rows, suggested_subjects)
